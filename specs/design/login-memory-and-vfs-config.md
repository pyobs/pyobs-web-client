...
replaced it with a Bearer `token` — migrated client-side too now, see
`specs/plans/2026-08-04-vfs-token-auth.md` (status: done). Kept as historical record of the
original design rather than rewritten in place.
