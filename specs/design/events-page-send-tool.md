...
(see `specs/design/pyobs-2-0-wire-protocol-client.md`'s intro — "no
build-time codegen — everything is discovered live from each module's own
disco#info response"). There is no
