...
Telescope-page proposals, both fully superseded by `specs/plans/2026-08-03-camera-page.md` and
`specs/plans/2026-08-03-telescope-page.md` — is preserved in git history rather than duplicated in both
...
- ~~`IMode` widget~~ — **done**, plan at `specs/plans/2026-08-03-mode-widget.md`
  (`ModeView.vue`, #10).
- ~~`IWeather` widget~~ — **implemented**, plan at
  `specs/plans/2026-08-03-weather-widget.md` (`WeatherView.vue`, new hand-rolled
...
- ~~`IAutoFocus` widget~~ — **done**, plan at `specs/plans/2026-08-03-autofocus-widget.md`
...
- ~~`IAutoGuiding` widget~~ — **done**, plan at
  `specs/plans/2026-08-03-autoguiding-widget.md` (`AutoGuidingView.vue`, new
...
- ~~`IAcquisition` widget~~ — **done**, plan at
  `specs/plans/2026-08-03-acquisition-widget.md` (`AcquisitionView.vue`, new
...
- ~~**Camera page**~~ — **done**, plan at `specs/plans/2026-08-03-camera-page.md` (single-shot
...
- **Telescope page** — plan moved to `specs/plans/2026-08-03-telescope-page.md` (now also
...
- **ACL-aware Shell forms** — plan moved to `specs/plans/2026-08-03-acl-aware-shell-forms.md`.
...
- **`IDataSequence`** — plan moved to `specs/plans/2026-08-03-idatasequence.md`. Depends on
...
- **Non-sidereal tracking** (`ITrackingMode`/`ITrackingRate`/`IPointingBody`/
  ...
  `specs/plans/2026-08-03-telescope-page.md` rather than its own plan, since it's purely
...
- **`struct<Name>`-typed command params can't be form-built from schema alone**
  — plan moved to `specs/plans/2026-08-03-struct-typed-command-params.md`. Blocked on
